      ...
      <div className="publication-section">
        <div className="presentation-section">
          ...
          <div className="indent1">
            1. Vegetable Consumption by Low-Socioeconomic Patients Targeted for
            Produce Rx. Win R**, Smith E*, Sastre L. Poster Presentation. Food
          ...
          <div className="indent1">
            ...
            with Diabetes. Stroud B*, Batt H**, Humphries W, Liang C, Sastre L.
            Poster Presentation. Food Insecurity, Neighborhood Food Environment,
            and Nutrition Health Disparities: State of the Science, National
            Institute of Health. September 23, 2021.
          </div>
          <div className="indent1">
            3. Farmer's Perceptions of Gleaning: Opportunities and Barriers to
            Food Recovery. Stroud B, Bradshaw R, Sastre L. Poster Presentation.
            Food Insecurity, Neighborhood Food Environment, and Nutrition Health
            Disparities: State of the Science, National Institute of Health.
            September 23, 2021.
          </div>
          <div className="indent1">
            4. Food Insecurity, Food-Based Interventions and Chronic Disease
            Management. Batt H**, Jacobs M, Sastre L. Poster Presentation. Food
            Insecurity, Neighborhood Food Environment, and Nutrition Health
            Disparities: State of the Science, National Institute of Health.
            September 23, 2021.{" "}
          </div>
          <div className="indent1">
            ...
            Batt H**, Stroud B*, Liang C, Sastre L. Poster Presentation. SOPHE
            2022 73rd Annual Conference, Health Education: The ARCH of an Era,
            March 22-25, 2022.{" "}
          </div>
          <div className="indent1">
            6. We Asked, Patients Answered: Preferences for a Produce Rx
            Program. Hendrix K**, Smith E*, Stroud B*, Sastre L. Virtual Poster
            Presentation. American Public Health Association (APHA) 2021 Annual
            Meeting, Denver, Colorado October 22, 2021.{" "}
          </div>
          <div className="indent1">
            ...
            Association (APHA) 2021 Annual Meeting, Denver, Colorado October 22,
            2021.{" "}
          </div>
          <div className="indent1">
            8. Fresh Start: A comprehensive nutrition program targeting multiple
            social determinants of health to optimize diabetes management with
            uninsured patients. Stroud B*, Sastre L. Poster Presentation.
          ...
          <div className="indent1">
            ...
            uninsured patients with type-2 diabetes improves glycemic control.
            Stroud B*, Sastre L. Oral Presentation. American Public Health
            Association (APHA) 2021 Annual Meeting, Boston MA, November 9, 2022.{" "}
          </div>
          <div className="publication-title">Peer-Review Publications</div>
          <div className="indent1">
            1. Tripp M, Jacobs M, Sastre L. (2020) Perceptions, Satisfaction,
            and Experience of Low-Socioeconomic, Rural Patients Who Participated
            in a Pilot Farm to Clinic (F2C) Program Utilizing Local, Donated
